...
## Updated Features
- The `/get_recommendations` endpoint now accepts both POST and GET methods.
- Added input validation to ensure all required fields (city, state, age, gender) are provided.
- Enhanced comments in the code for clarity regarding data handling and filtering logic.
...
Additionally, the recommendation logic has been updated to improve the accuracy of product suggestions based on customer demographics.

Additionally, new insights have been gathered from the latest analysis, which include updated customer segments and visualization results.
...
- The data quality of the datasets has been improved significantly, leading to more accurate insights.
...
### 4. RFM Analysis: Scatter Plots and New Findings
#### Recency vs Monetary :
